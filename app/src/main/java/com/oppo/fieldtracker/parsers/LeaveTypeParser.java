                ...
                for (int i = 0; i < array.length() ; i++) {
                    ...
                    if(childObject.has("description")) {
                        ...
                        if(childObject.has("enumId")) {
                           ...
                           // LeaveType.type.put(childObject.getString("enumId"),childObject.getString("description"));
                            list.add(leaveType);
                ...
                for (int i = 0; i < array.length() ; i++) {
                    ...
                    if(childObject.has("description")) {
                        ...
                        if(childObject.has("enumId")) {
                         ...
                         //   LeaveReason.reason.put(childObject.getString("enumId"),childObject.getString("description"));
