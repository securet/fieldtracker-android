...
import com.oppo.fieldtracker.model.PromoterApprovals;
                    ...
                    if(childObject.has("requestJson")){
                        ...
                        if(object.has("requestType")) {
                            ...
                            if(object.has("requestInfo")) {
                                ...
                                for (Map.Entry<String,String> hm : Store.storeMap.entrySet()) {
                                    if(hm.getKey().equals(o.getString("productStoreId"))) {
                                        promoter.setStoreName(hm.getValue());
                                    }
                                }
