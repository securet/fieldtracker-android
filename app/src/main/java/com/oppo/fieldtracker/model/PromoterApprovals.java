...
public class PromoterApprovals implements Parcelable{
    ...
    public static final Creator<PromoterApprovals> CREATOR = new Creator<PromoterApprovals>() {
        @Override
        public PromoterApprovals createFromParcel(Parcel in) {
            return new PromoterApprovals(in);
        }

        @Override
        public PromoterApprovals[] newArray(int size) {
            return new PromoterApprovals[size];
        }
    };
