...
/**
 * Created by AllSmart-LT008 on 8/17/2016.
 */
public final class Logger {
    private static final String TAG = "ATTENDANCETRACKER";
    private static final boolean LOG_ENABLE = AppsConstant.isDebug;
