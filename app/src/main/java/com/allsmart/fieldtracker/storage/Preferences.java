package com.allsmart.fieldtracker.storage;
...
//    public static String SITEID = "SiteId";
    ...
    public static String STORE_LIST_COUNT = "storeListCount";
    ...
    public static String REPORTEE_MANAGER_EMAIL = "reporteeManagerEmail";
    public static String REPORTEE_MANAGER_PHONE = "reporteeMangerPhone";
