...
public class LoginActivity extends Activity implements LoaderManager.LoaderCallbacks , View.OnClickListener {
    ...
    EditText emailET, passwordET, newPass, confirmPass, domain;
    TextView forgotPass;
//    ProgressDialog pd;
        ...
        switch (v.getId()) {
            case R.id.loginBtn:
                if ((emailET.getText().toString().trim().equals(null))
                    ...
                    if(!TextUtils.isEmpty(emailET.getText().toString()) && !TextUtils.isEmpty(domain.getText().toString())){
                        if(emailValidator(emailET.getText().toString())) {
                            ...
                            if(checkLocationPermision()) {
                                ...
                                if (!gps_enabled && !network_enabled) {
                                    ...
                                    preferences.saveString(Preferences.DOMAIN,domain.getText().toString().trim());
                                    preferences.commit();

                                    Services.setDomain(preferences.getString(Preferences.DOMAIN,""));
                                    Log.d(MainActivity.TAG,domain.getText().toString());
